...
# Gratuitously stolen from @mathiasbynens (with some personal additions).
...
##Set mouse rightclick to open rightclick menu
defaults write NSGlobalDomain com.apple.swipescrolldirection -bool fals
...
defaults write NSGlobalDomain com.apple.swipescrolldirection -bool false To set it back: defaults write NSGlobalDomain com.apple.swipescrolldirection -bool true
...
#Stop icons from sticking around in the dock after being closed
defaults write com.apple.dock show-recents -bool no
defaults write com.apple.dock recent-apps -array # intentionally empty

##Make dock small
defaults write com.apple.dock tilesize -integer 15; killall Dock
